...
export default function CarCard() {
  return (
    <div className="container">
      <div className="row">
        <div className={`col-12 col-md-6 col-xl-4 shadow p-0 ${styles.boxcar}`}>
          <div>
            <div className="">
              <img
                src="https://image123.azureedge.net/dmndautosales/thumb-2020-Toyota-Camry-855360210640679.jpg"
            ...
            <div className="m-3 d-flex align-items-center justify-content-between">
              <div className="d-flex align-items-center">
                <input
                  ...
                  id="120471"
                />
                <p className={`${styles.Comparetext} m-0 px-1`}>Select For Compare</p>
              </div>
            ...
            <div>
              <div className=" m-3 p-0">
                <p className={`${styles.finaceFormsize} pb-1`}>Finance form :</p>
              </div>
              ...
              <div className="row mx-3  ">
                ...
                <p className={`col-6 ${styles.aboutt2} p-2 m-0`}>4 Cylinder</p>
              </div>
              <div className={`row mx-3 ${styles.gray} `}>
                <p className={`col-6 ${styles.aboutt1} p-2 m-0`}>Drivetrain :</p>
                <p className={`col-6 ${styles.aboutt2} p-2 m-0`}>FWD</p>
              </div>
              <div className="row mx-3   ">
                <p className={`col-6 ${styles.aboutt1} p-2 m-0`}>Fuel Type :</p>
                <p className={`col-6 ${styles.aboutt2} p-2 m-0`}>Gasoline</p>
              </div>
              <div className={`row mx-3 ${styles.gray} `}>
                <p className={`col-6 ${styles.aboutt1} p-2 m-0`}>Transmission : :</p>
            ...
            <div className="m-3 d-flex justify-content-between ">
              <div className="d-flex">
                <div><FaLocationPin className={styles.icons}/></div>
                <a href="" className="p-0 mx-1 m-0 text-decoration-none text-start">DMND Auto Sales</a>
              </div>
              <div className="d-flex">
                <div><FaPhoneAlt className={styles.icons}/></div>
                <a href="" className="p-0 mx-1 m-0 text-decoration-none text-start">Tel:4162749773</a>
              </div>
              
            </div>
            <div className="text-center mb-3">
              <img src="https://hzd-on-dmndautosales.azurewebsites.net/images/inventory/carfaxcanada_icon.png" alt="" className={styles.certificate}/>
            </div>
          </div>
        </div>
      </div>
