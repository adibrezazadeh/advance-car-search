...
async function sortView(router,sort,setCarList) {
    ...
    const bodydata={
      ...
      const res2 = await fetch(
        `https://api.hillzusers.com/api/dealership/advance/search/vehicles/${window.location.host}?page=1&limit=10&keywords=${bodydata.keywords}&${sort}=ASC`
      ,{
        method: 'POST',
        headers: {
